...
class ModelTrainerGUI:
    ...
    def setup_ui(self):
        ...
        auto_report_check = ttk.Checkbutton(main_frame, text="Auto-generate evaluation report", 
                                           variable=self.auto_report_var)
        auto_report_check.grid(row=7, column=0, columnspan=2, sticky=tk.W, pady=(10, 0))
        ...
        self.progress.grid(row=9, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=(20, 0))
    ...
    def train_model(self):
        try:
            ...
            report_path = None
            if auto_report:
                self.root.after(0, lambda: self.status_label.config(text="Generating evaluation report...", foreground="blue"))
    ...
    def training_completed(self, save_path, report_path=None):
        ...
        if report_path:
            self.status_label.config(text=f"Training completed! Model and report saved.", foreground="green")
